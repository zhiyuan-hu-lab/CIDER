...
-   Genome Biology (2021) publication: [CIDER article]((https://genomebiology.biomedcentral.com/articles/10.1186/s13059-021-02561-2))
-   Original prototype: [Hu et al., *Cancer Cell* 2020](https://www.sciencedirect.com/science/article/pii/S1535610820300428)
...
You can install CIDER from [github](https://github.com/zhiyuan-hu-lab/CIDER/) with:
...
![Evaluation scatterplot showing CIDER-based p-values and similarity](man/figures/evaluation_scatterplot.png)

For a more detailed walkthrough, see the [detailed tutorial of evaluation](https://zhiyuan-hu-lab.github.io/CIDER/articles/evaluation.html)
...
The final clusters will be stored in `seu@meta.data$final_cluster` (by default).

-   Detailed tutorial: [asCIDER tutorial](https://zhiyhu.github.io/CIDER/articles/asCIDER.html)
-   If you do not have prior batch-specific clusters, see [dnCIDER high-level](https://zhiyhu.github.io/CIDER/articles/dnCIDER_highlevel.html) or the [dnCIDER detailed walk-through](https://zhiyhu.github.io/CIDER/articles/dnCIDER.html).
...
Z. Hu, A. A. Ahmed, C. Yau. CIDER: an interpretable meta-clustering framework for single-cell RNA-seq data integration and evaluation. *Genome Biology* **22**, Article number: 337 (2021); [doi: https://doi.org/10.1186/s13059-021-02561-2](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-021-02561-2)
